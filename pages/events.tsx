...
const Events: NextPage = () => {
      ...
      <div className={styles.modal}>
        <div className={styles.modalContent}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={styles.formGroup}>
              <label className={styles.textBlack}>Scope of Work (tags, comma-separated)</label>
              <input
                type="text"
                value={scopeOfWork}
            ...
            <div className={styles.formGroup}>
              ...
              <select value={eventLocation} onChange={(e) => setEventLocation(e.target.value)} required>
            ...
            <div className={styles.formGroup}>
              <label className={styles.textBlack}>Hypercert Header Image Link</label>
              <input
                type="url"
                value={headerImage}
  ...
  <div className={styles.eventsPage}>
    <HomeButton />
    <button className={styles.button} onClick={() => setShowModal(true)}>Create Event</button>
